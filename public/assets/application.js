...
;(function(window, document, $) {
	...
	if (isInputSupported && isTextareaSupported) {
		...
		placeholder = prototype.placeholder = function() {
			var $this = this;
			$this
				.filter((isInputSupported ? 'textarea' : ':input') + '[placeholder], ' + (isInputSupported ? 'textarea' : ':input') + '[placeholder-value]')
				.not('.placeholder')
				.bind({
	...
	function setPlaceholder() {
		...
		if (input.value == '') {
			...
			$input[0].value = $input.attr('placeholder') || $input.attr('placeholder-value');
		} else {
			$input.removeClass('placeholder');
		}
	}
...
function showLoader($el, text) {
  ...
  css('overflow','hidden').
  append('<div class="mask">' + txtHtml + '<img src="/assets/ajax-loader.gif" alt="..."/></div>');
...
$(document).ready(function() {
  ...
  $("#").submit(function(event) {
    ...
    if (!error) {
      ...
      console.log("form submited from show loader");
      $.ajax({
        type: "POST",
